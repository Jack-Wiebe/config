# Generated by Powerlevel10k configuration wizard on 2025-11-06 at 10:47 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_EMPTY_LINE_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%040F\ue285'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=040
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND=16
  typeset -g POWERLEVEL9K_BATTERY_LOW_BACKGROUND=1
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=16
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_BACKGROUND=040
  # Show battery in yellow when it's discharging.
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=16
